...
(custom-theme-set-faces
 ...
 '(clojure-test-success-face ((((class color) (min-colors 89)) (:background nil :foreground nil :underline "#b5bd68"))))
 '(edts-face-warning-line ((((class color) (min-colors 89)) (:background nil :inherit flymake-warnline))))
 '(edts-face-warning-mode-line ((((class color) (min-colors 89)) (:background nil :foreground "#de935f" :weight bold))))
 '(edts-face-error-line ((((class color) (min-colors 89)) (:background nil :inherit flymake-errline))))
 '(edts-face-error-mode-line ((((class color) (min-colors 89)) (:background nil :foreground "#cc6666" :weight bold))))
 ...
 '(clojure-double-quote ((((class color) (min-colors 89)) (:foreground "#8abeb7" :background nil))))
 ...
 '(region ((((class color) (min-colors 89))
            (:background "#8F621D" :inverse-video nil))))
 ...
 '(helm-ff-directory ((((class color) (min-colors 89)) (:foreground "SkyBlue" :background nil :weight bold))))
 '(helm-buffer-directory ((((class color) (min-colors 89)) (:foreground "SkyBlue" :background nil :weight bold))))
 ...
 '(helm-selection ((((class color) (min-colors 89))
                    (:inherit highlight :background "#373b41" :underline nil :box (:line-width -1 :color "#000000")))))
 ...
 '(default ((((class color) (min-colors 89)) (:foreground "#F4EAD5" :background "#1d1f21"))))
 ;; '(default ((((class color) (min-colors 89)) (:foreground "#F4EAD5" :background "#110F13"))))
 ;; '(default ((((class color) (min-colors 89)) (:foreground "#c5c8c6" :background "#110F13"))))
 ;; '(hl-line ((t (:inherit highlight :background "#151515" :underline t)))))
