...
(define-key symbol-focus-mode-map (kbd "C-S-b") 'sf/back)
(define-key symbol-focus-mode-map (kbd "C-S-n") 'sf/next)
(define-key symbol-focus-mode-map (kbd "C-S-p") 'sf/prev)
(define-key symbol-focus-mode-map (kbd "C-S-r") 'sf/reset)
