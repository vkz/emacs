;;; ze-flycheck.el --- Additional utilities for Flycheck  -*- lexical-binding: t; -*-
...
(defun ze-discard-undesired-html-tidy-error (err)
...
(defun ze-flycheck-mode-line-status ()
