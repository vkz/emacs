;;; ze-lisp.el --- Utilities for Lisp  -*- lexical-binding: t; -*-
...
(defun ze-find-cask-file (other-window)
...
(defun ze-emacs-lisp-current-feature ()
...
(defconst ze-use-package-imenu-expression
...
(defun ze-add-use-package-to-imenu ()
  "Add `use-package' declarations to `imenu'."
  (add-to-list 'imenu-generic-expression
               ze-use-package-imenu-expression))
